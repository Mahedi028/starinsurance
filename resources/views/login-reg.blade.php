...
<form onsubmit="loginForm(event)" class="woocommerce-form woocommerce-form-login login mb-3" method="post" style="height: 457px;">
...
<form onsubmit="registerForm(event)" method="post" class="woocommerce-form woocommerce-form-register register" style="height: 457px;">
