    ...
    <section class="elementor-section elementor-top-section elementor-element elementor-element-5b3eada hide-logged-out elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="5b3eada" data-element_type="section">
        ...
        <div class="card">
            <div class="card-body table-responsive">
                @if(count($orders) == 0)
                <div class="alert alert-info py-5"> You currently have no policy. <a href="/policy/get-quote"> Get a quote now</a> </div>
                @else
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button onclick="showPolicyDetails({{$order->id}})" class="btn m-1 btn-sm btn-primary">View Details</button> <a target="_blank" href="/my-account/insurace-certificate/{{$order->policy_number}}" class="btn btn-primary m-1 btn-sm">Insurance Certificate</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 950px; width: 100%;">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="authModalLabel">Policy Details</h5>
